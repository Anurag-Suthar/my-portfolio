...
export default function ProjectsPage() {
  const projects = [
    ...
    {
      title: "Blog Platform",
      description: "A blog platform with a custom CMS built with Next.js and Sanity.io.",
      image: "/placeholder.svg?height=300&width=600",
    ...
    {
      title: "Recipe App",
      description: "A recipe application that allows users to search, save, and share recipes.",
      image: "/placeholder.svg?height=300&width=600",
